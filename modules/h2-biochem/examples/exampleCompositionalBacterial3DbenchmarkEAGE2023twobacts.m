...
arg = {G, rock, fluid, compFluid, biochemFluid, true, backend, ...
    ...
    'bacteriamodel', false,'molecularDispersion',false, 'molecularDiffusion',true, ...
...
model_bact = BiochemistryModel(G, rock, fluid, compFluid, biochemFluid, true, backend, ...
    'water', false, 'oil', true, 'gas', true, ...
    'bacteriamodel', true, 'bactDiffusion', false, 'molecularDiffusion', true, 'molecularDipersion', false,'chemotaxisEffect',false,...
    'liquidPhase', 'O', 'vaporPhase', 'G');
