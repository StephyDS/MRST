classdef MicrobialChemotaxis < StateFunction
    ...
    %
    % DESCRIPTION:
    %   Evaluates the effective cell‑centred microbial chemotaxis
    ...
    %
    % REQUIRED PARAMETERS:
    %   model - Model instance, must have fields `chemotaxiseffect` (logical)
    %           and `biochemFluid.chemotaxiseffect` (positive numeric).
    %
