...
% Component changes
H2_loss = (abs(results_nobact.totMassH2 - results_nobact_moldiff.totMassH2) ./ results_nobact.totMassH2) * 100;
CO2_loss = (abs(results_nobact.totMassCO2 - results_nobact_moldiff.totMassCO2) ./ results_nobact.totMassCO2) * 100;
C1_gain  = (abs(results_nobact.totMassC1 - results_nobact_moldiff.totMassC1) ./ results_nobact.totMassC1) * 100;
...
fprintf('H2 Production Efficiency (With bacteria, with dispersion): %.2f%%\n', eff_bact);
