...
%function schedule = createCyclicScenario2(rampupTime, nCycles, buildUpLength, restLength, injectionLength, idle0Length, productionLength, idleLength, W)
schedule = createCyclicScenario2( 1*day, 1, 60*day, 10*day, 30*day,20*day, 30*day,20*day, [W1;W2;W3;W5]);
