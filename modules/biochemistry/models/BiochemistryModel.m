    ...
    methods
        ...
        function model = BiochemistryModel(G, rock, fluid, compFluid, includeWater, backend, varargin)
            ...
            if model.dispersion
                ...
                model.alphaL(L_i)=1.e-3;%1.e-3;%1.e-2; %Longitudinal dispersivity coefficient in water phase,  m (0.01->1m)
                model.alphaT(L_i)=1.e-4;%1.e-4;%1.e-3;%Transversal dispersivity coefficient in water phase,  m 
                model.alphaL(V_i)=5.e-3; %5.e-3; %5.e-2; %Longitudinal dispersivity coefficient in gas phase,  m (0.1->5m)
                model.alphaT(V_i)=5.e-4;%5.e-4;%5.e-3;%Transversal dispersivity coefficient in gas phase,  m 
            end
