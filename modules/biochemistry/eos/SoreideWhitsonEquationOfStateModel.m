classdef SoreideWhitsonEquationOfStateModel < PhysicalModel
    ...
    methods
        function model = SoreideWhitsonEquationOfStateModel(G, fluid, eosname)
            if nargin < 3
                eosname = 'SW';
            end
            ...
            switch model.eosType
                ...
                case {6}
                    ...
                    % We keep same parameters as PR for the gasous phase
                     ...
                     % Here binary interactions depends on T
                     bic = model.CompositionalMixture.getBinaryInteractionGasWater(T);                    
                otherwise
